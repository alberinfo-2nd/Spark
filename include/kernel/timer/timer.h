...
struct TIMER_Timestamp_t TIMER_get_boot_timestamp(void); //Get how much time passed since boot in nanosecs; Will try to use the TSC by default
struct TIMER_Timestamp_t TIMER_get_time_since(struct TIMER_Timestamp_t previous_timestamp);
